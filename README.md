...
[![Modrinth](https://img.shields.io/modrinth/dt/beautify-refoxed?color=00AF5C&label=downloads&logo=modrinth)](https://modrinth.com/mod/beautify-refoxed)
[![](http://cf.way2muchnoise.eu/full_1446138_downloads.svg)](https://www.curseforge.com/minecraft/mc-mods/beautify-refoxed)
[![Minecraft Versions](https://cf.way2muchnoise.eu/versions/1446138.svg)](https://www.curseforge.com/minecraft/mc-mods/beautify-refoxed)

#### This mod is maintained as the [original author](https://github.com/Pandarix) has not updated it for over a year. It will be discontinued once the original author resumes updates.
#### Ported from my [fabric](https://github.com/Suel-ki/Beautify-Refabricated) version, it has minor detail differences from the [original](https://github.com/Pandarix/Beautify).

This is the Unofficial NeoForge version of [Beautify](https://github.com/Pandarix/Beautify), licensed under [MIT](https://github.com/Pandarix/Beautify/blob/main/LICENSE), please support the original work!
...
- [more example images](https://www.curseforge.com/minecraft/mc-mods/beautify-refoxed/gallery)
